<template>
  <div class="my-header">
    <div></div>
    <div class="tips">Just press your keyboard!</div>
    <a href="https://github.com/SpacesoulsL/JustPressYourKeyboard" target="_blank" class="share">
      <span style="margin-right: 10px">STAR IT</span>
      <svg
        t="1686754273379"
        class="icon"
